LDAvis = function(to_select, json_file) {
	...
	if (xdiff > ydiff) {
        ...
        var mywidth = window.innerWidth * .6;
        ...
        var chart = svg.append("g")
            ...
            .attr("transform", "translate(" + +(0 + margin.left + termwidth) + "," + 2 * margin.top + ")")
            .attr("id", "bar-freqs");
	...
	// dynamically create the topic and lambda input forms at the top of the page:
	    ...
	    inputDiv.setAttribute("style", "width: 60vw; display: inline-block"); // to match the width of the main svg element
	    document.getElementById(visID).appendChild(inputDiv);

	    // topic input container:
	    var topicDiv = document.createElement("div");
	    topicDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: none; width: " + mdswidth + "px; height: 50px; float: left");
	    ...
	    clear.innerHTML = "Clear Topic";
    	    ...
    	    lambdaDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; height: 50px; width: " + lambdaDivWidth + "px; float: left; margin-left: 20px;  margin-right: 30px");
